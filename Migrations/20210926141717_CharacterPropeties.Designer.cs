...
namespace CURSO_UDEMY_COGNIZANT_netcore31webapi.Migrations
{
    ...
    [Migration("20210926141717_CharacterPropeties")]
    partial class CharacterPropeties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Weapon", b =>
                {
                    b.HasOne("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Character", "Character")
                        .WithOne("Weapon")
                        .HasForeignKey("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Weapon", "CharacterId")
            ...
            modelBuilder.Entity("CharacterSkill", b =>
                {
                    b.HasOne("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Character", null)
                        .WithMany()
                        .HasForeignKey("CharactersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CURSO_UDEMY_COGNIZANT_netcore31webapi.Models.Skill", null)
                        .WithMany()
